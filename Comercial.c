...
main (void)
{
	...
	res= calcularPromedios(comerciales,num,promediosComerciales,promediosMeses);	
...
{	
	...
	for(i=0;i<NUM_MESES;i++){
		#ifdef DEBUG
		fprintf(stderr,"\n\n");
		fprintf(stderr,"%d LOS VALORES A SUMAR SON: \n",i+1);
		...
		for(j=0;j<numComerciales;j++){
			...
			#ifdef DEBUG
				//fprintf(stderr,"\n\n");
				//fprintf(stderr,"LOS VALORES A SUMAR SON: \n");
				fprintf(stderr,"%d\n",comerciales[j].ventas[i]);
			#endif
		}
		#ifdef DEBUG
			fprintf(stderr,"\n\n");
			fprintf(stderr,"SUMADOS SON: \n");
			fprintf(stderr,"%f\n",promedioMesesI);
			fprintf(stderr,"DIVIDIDOS SON: \n");
			fprintf(stderr,"%f\n",promedioMesesI/numComerciales);
			fprintf(stderr,"\n\n");
		#endif
